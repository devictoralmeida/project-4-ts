...
const loadPokemon = () => {
    ...
    for (let [key, value] of Object.entries(pokemon)) {
        const pokemonAttributes = document.querySelector(".pokemon__attribute-names");
        const pokemonAttributesValues = document.querySelector(".pokemon__attribute-values");
        key = key.replace("_", " ");
...
const loadMovie = () => {
    ...
    for (let [key, value] of Object.entries(movie)) {
        ...
        const movieAttributesValues = document.querySelector(".movie__attribute-values");
        key = key.replace("_", " ");
        const attributeName = document.createElement("th");
        const attributeValue = document.createElement("td");
        attributeName.innerText = key;
...
const loadCountry = () => {
    ...
    for (let [key, value] of Object.entries(country)) {
        const countryAttributes = document.querySelector(".country__attribute-names");
        const countryAttributesValues = document.querySelector(".country__attribute-values");
        key = key.replace("_", " ");
